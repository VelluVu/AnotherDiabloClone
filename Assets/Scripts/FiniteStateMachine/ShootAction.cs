...
public class ShootAction : Action
{
    ...
    public void ShootAtTarget ( StateController controller, EnemyWeaponHolder weapon )
    {
        ...
        if ( weapon.GetIsShootRdy ( ) )
        {
            ...
            weapon.Shoot ( controller.enemyStats.attackDamage.Value, controller.enemyStats.attackSpeed.Value, controller.spotDistance, controller.chaseTarget, controller.targetLayer,controller.enemyStats.level );
        }
    }
}
